...
/** `A` whose equalIsNatural == false. Useful when testing [[scalaz.Equal]] instances that
  * short-circuit when the tparam's equalIsNatural, so you're testing the handwritten paths rather
  * than the compiler-generated ones.
  */
