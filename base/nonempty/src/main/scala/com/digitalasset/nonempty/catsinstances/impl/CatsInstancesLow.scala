...
import cats.{Eval, Foldable, Functor, Monoid, Reducible, Semigroup, Traverse}
import com.daml.scalautil.ImplicitPreference

trait CatsInstances extends CatsInstancesLow {
...
trait CatsInstancesLow extends CatsInstancesLow1 {
