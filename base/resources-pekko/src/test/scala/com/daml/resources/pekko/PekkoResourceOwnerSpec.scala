...
final class PekkoResourceOwnerSpec extends AsyncWordSpec with Matchers {
  private val Factories = new ResourceOwnerFactories[TestContext]
    with PekkoResourceOwnerFactories[TestContext] {
    ...
    "convert to a ResourceOwner" in {
      ...
      class TestActor extends Actor {
        ...
        override def receive: Receive = {
          case msg: Int => testPromise.success(msg)
          case msg => testPromise.failure(new IllegalArgumentException(s"$msg"))
        }
      }
