...
.. snippet:: simple_party_replication
    .. hidden:: bootstrap.synchronizer(
         ...
         staticSynchronizerParameters = StaticSynchronizerParameters.defaults(CryptoConfig(), ProtocolVersion.forSynchronizer, topologyChangeDelay = NonNegativeFiniteDuration.Zero)
       )
