...
.. wip::
    Link to overview section on the difference between community and enterprise editions.
    Update the location of enterprise release artifacts.

.. _download-release-bundle:
