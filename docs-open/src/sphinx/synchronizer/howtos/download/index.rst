...
.. wip::
    Link to participant how to download the canton release bundle and the docker images.
    Once we have specific node docker images document how to download them.

.. _synchronizer-download-release-bundle:
