...
class UpgradingIT(testDars: TestDars) extends LedgerTestSuite {
  ...
  test(
    ...
    for {
      ...
      _ <- upload(ledger, UpgradeTestDar1_0_0)
      ...
      _ <- upload(ledger, UpgradeTestDar2_0_0)
      ...
      _ <- upload(ledger, UpgradeTestDar3_0_0)
  ...
  test(
    ...
    for {
      ...
      _ <- upload(ledger, UpgradeFetchTestDar1_0_0)
      ...
      _ <- upload(ledger, UpgradeFetchTestDar2_0_0)
...
object UpgradingIT {
  ...
  private def upload(ledger: ParticipantTestContext, dar: TestDar): Future[Unit] =
    ledger.uploadDarFileAndVetOnConnectedSynchronizers(dar.bytes)
