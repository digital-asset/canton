...
final class PackageManagementServiceIT(testDars: TestDars) extends LedgerTestSuite {
  private val testPackageResourcePath = testDars.PackageManagementTestDar.path
