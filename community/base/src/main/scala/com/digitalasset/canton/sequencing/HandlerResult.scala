...
object HandlerResult {
  ...
  /** The given [[com.digitalasset.canton.lifecycle.FutureUnlessShutdown]] shall be run
    ...
    * has completed with a [[com.digitalasset.canton.lifecycle.UnlessShutdown.Outcome]]. Later
    * requests will also only be processed after this future has completed with an
    * [[com.digitalasset.canton.lifecycle.UnlessShutdown.Outcome]]. If the future fails with an
  ...
  /** The given [[com.digitalasset.canton.lifecycle.FutureUnlessShutdown]] is an asynchronous
    ...
    * events' asynchronous processing * Later events' synchronous and asynchronous processing *
    * Later stages of synchronous processing for the same event The event will be marked as clean
    * only after the future has completed successfully with
    * [[com.digitalasset.canton.lifecycle.UnlessShutdown.Outcome]]. If the future fails with an
    * exception or returns
    * [[com.digitalasset.canton.lifecycle.UnlessShutdown.AbortedDueToShutdown]], the sequencer
