...
/** Policy for what errors are considered retryable. Each
  * [[com.digitalasset.canton.sequencing.SequencerConnectionWithPekkoSubscribe]] is expected to
  * supply their own policy which can consider error types they have defined.
  */
