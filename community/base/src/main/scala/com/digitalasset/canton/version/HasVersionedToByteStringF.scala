...
/** Trait for classes that can be serialized to a [[com.google.protobuf.ByteString]]. Typical use
  * cases of toByteString include:
  *   - saving data in the database in serialized form (e.g. as in SequencedEvent)
  *   - encrypting data (e.g. as in Encryption.scala)
  *
  * In some exceptional cases, we also convert an object to a ByteString before including it in a
  * Proto message (e.g. ViewCommonData or Envelope)
  *
