...
import com.digitalasset.canton.util.SimpleExecutionQueueWithShutdown.TaskCell
...
/** Functions executed with this class will only run when all previous calls have completed executing.
  ...
  */
class SimpleExecutionQueueWithShutdown(
    name: String,
  ...
  override def pretty: Pretty[SimpleExecutionQueueWithShutdown] = prettyOfClass(
...
object SimpleExecutionQueueWithShutdown {
