...
object NamespaceDelegation extends TopologyMappingCompanion {
  ...
  def fromProtoV31(
    ...
    for {
      ...
      explicitRestriction <- DelegationRestriction.fromProtoV31(value.restriction)
      finalRestriction = explicitRestriction match {
...
final case class MediatorSynchronizerState private (
  ...
  def toProto: v30.MediatorSynchronizerState =
    v30.MediatorSynchronizerState(
      ...
      observers = observers.map(o => o.uid.toProtoPrimitive),
    )
...
object LsuAnnouncement extends TopologyMappingCompanion {
  ...
  def fromProtoV30(
    ...
    } yield LsuAnnouncement(successorSynchronizerId, upgradeTime)
}
