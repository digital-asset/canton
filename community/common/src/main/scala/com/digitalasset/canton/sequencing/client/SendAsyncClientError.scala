...
object SendAsyncClientError {
  ...
  case class RequestInvalid(message: String) extends SendAsyncClientError {
  ...
  case class RequestFailed(message: String) extends SendAsyncClientError {
  ...
  case class RequestRefused(error: SendAsyncError) extends SendAsyncClientError {
