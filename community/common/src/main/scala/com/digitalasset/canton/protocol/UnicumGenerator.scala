...
/** Generates [[Unicum]]s for contract IDs such that the [[Unicum]] is a cryptographic commitment to the following:
  * <ul>
  *   <li>The [[DomainId]] of the transaction that creates the contract</li>
  ...
  * <ol>
  *   <li>[[DomainId]], [[com.digitalasset.canton.topology.MediatorId]], the `UUID`,
  ...
  *   The definition of the virtual domain ledger ensures that transaction UUIDs are unique within the [[com.daml.api.util.LedgerEffectiveTimeTolerance]]
  ...
  *
  *   We include both the [[DomainId]] and the [[com.digitalasset.canton.topology.MediatorId]] in the [[ContractSalt]]
