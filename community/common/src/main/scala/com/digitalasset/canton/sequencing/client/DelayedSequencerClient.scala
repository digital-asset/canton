...
case class DelayedSequencerClient(domain: DomainId, member: String) extends DelaySequencedEvent {
...
object DelayedSequencerClient {
  ...
  case class DelayUntil(override val until: Future[Unit]) extends DelaySequencerClient
