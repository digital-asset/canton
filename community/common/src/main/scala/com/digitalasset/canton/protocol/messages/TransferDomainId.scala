...
case class TransferOutDomainId(override protected val domain: DomainId) extends TransferDomainId {
...
case class TransferInDomainId(override protected val domain: DomainId) extends TransferDomainId {
