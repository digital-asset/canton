...
import com.digitalasset.canton.SystematicTesting.Operability.OperabilityTest
...
/** Annotations to classify tests according to security and reliability */
...
object SystematicTesting {
  ...
  /** A functional test case.
    ...
    */
  case class FuncTest(topics: Seq[String], features: Seq[String]) extends TestTag
  ...
  /** A tag for a missing test case.
    ...
    */
  case class MissingTest(missingCoverage: String) extends TestTag
