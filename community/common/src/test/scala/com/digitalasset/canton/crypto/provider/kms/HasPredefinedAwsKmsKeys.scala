...
trait HasPredefinedAwsKmsKeys extends HasPredefinedKmsKeys {

  override val predefinedSymmetricEncryptionKey: KmsKeyId =
    KmsKeyId(String300.tryCreate("alias/canton-kms-test-key"))

  override val predefinedSigningKeys: Map[SigningKeySpec, (KmsKeyId, KmsKeyId)] = Map(
    SigningKeySpec.EcP256 -> (
      KmsKeyId(String300.tryCreate("alias/canton-kms-test-signing-key")),
      KmsKeyId(String300.tryCreate("alias/canton-kms-test-another-signing-key"))
    ),
    SigningKeySpec.EcP384 -> (
      KmsKeyId(String300.tryCreate("alias/canton-kms-test-signing-key-P384")),
      KmsKeyId(String300.tryCreate("alias/canton-kms-test-another-signing-key-P384"))
    ),
  ...
  override val predefinedAsymmetricEncryptionKeys: Map[EncryptionKeySpec, (KmsKeyId, KmsKeyId)] =
    Map(
      EncryptionKeySpec.Rsa2048 -> (
        KmsKeyId(String300.tryCreate("alias/canton-kms-test-asymmetric-key")),
        KmsKeyId(String300.tryCreate("alias/canton-kms-test-another-asymmetric-key"))
      )
    )
