...
class LtHash16Blake3Test extends AnyWordSpec with BaseTest {
  ...
  "LtHash16Blake3" should {
    ...
    "equals should return the expected result" in {
      LtHash16Blake3.empty.equals(LtHash16Blake3.empty) shouldBe true
      ...
      h1.equals(h1) shouldBe true
      h1.equals(h2) shouldBe true
      h2.equals(h1) shouldBe true
