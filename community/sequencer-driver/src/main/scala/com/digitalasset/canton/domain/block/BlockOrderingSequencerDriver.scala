...
object BlockOrderingSequencerDriver {
  ...
  class Factory[F <: BlockOrdererFactory](
    ...
    private class BlockOrdererSequencerDriver(
        blockOrderer: BlockOrderer,
        timeProvider: Option[TimeProvider],
