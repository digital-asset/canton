...
import com.digitalasset.canton.ledger.client.withoutledgerid.{LedgerClient => DamlLedgerClient}
...
import com.digitalasset.canton.ledger.api.domain.{PartyDetails => domainPartyDetails}
