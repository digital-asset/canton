...
object AuthServiceConfig {
  ...
  final case class UnsafeJwtHmac256(secret: String, targetAudience: Option[String])
  ...
  final case class JwtRs256(certificate: String, targetAudience: Option[String])
      extends AuthServiceConfig {
  ...
  final case class JwtRs256Jwks(url: String, targetAudience: Option[String])
      extends AuthServiceConfig {
