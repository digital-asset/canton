...
package com.digitalasset.canton.platform.store.migration.tests

import com.digitalasset.canton.platform.store.migration.MigrationTestSupport.{Row, row}
import com.digitalasset.canton.platform.store.migration.{DbConnectionAroundEachBase, DbDataTypes}
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers

abstract class MigrationEtqTests extends AnyFlatSpec with Matchers with DbConnectionAroundEachBase {
  import MigrationEtqTests.*
