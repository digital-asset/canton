...
import com.digitalasset.canton.protocol.messages.{DefaultOpenEnvelope, Digest, LegacyAcsCommitment, LegacyCommitmentPeriod, SignedProtocolMessage}
...
import com.digitalasset.canton.topology.{DefaultTestIdentities, ParticipantId, SynchronizerId, TestingTopology, UniqueIdentifier}
...
class AcsCommitmentBenchmark
  ...
  private object ParticipantTestMetrics
    ...
    val synchronizer: ConnectedSynchronizerMetrics =
      this.connectedSynchronizerMetrics(SynchronizerAlias.tryCreate("test"), DefaultTestIdentities.participant1)
  }
