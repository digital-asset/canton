...
object ApiCommand {
  ...
  /** Command for creating a contract
    *
    * @param templateRef
    *   the template that the contract is instantiating
    * @param argument
  ...
  /** Command for exercising a choice on an existing contract
    *
    * @param typeRef
    *   template or interface where the choice is defined
    * @param contractId
  ...
  /** Command for exercising a choice on an existing contract specified by its key
    *
    * @param templateRef
    *   template where the choice is defined
    * @param contractKey
  ...
  /** Command for creating a contract and exercising a choice on that existing contract within the
    * same transaction
    *
    * @param templateRef
...
/** A contract key passed in over the ledger API command submission
  *
  * @param templateRef
  *   the template whose key is being prefetched
  * @param contractKey
  *   the key value to prefetch
  * @param limit
