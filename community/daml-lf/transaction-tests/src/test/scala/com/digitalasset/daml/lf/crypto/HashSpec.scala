    ...
    "be stable " in {
      ...
      val expectedOut =
        """Unit
          ...
          | 13c6a7b85fcb0443c1d31dafe22561aac714fbaa99d3b9a56474d8dda0c9aee0
          |Timestamp(1969-07-21T02:56:15Z)
          | c4f34225847a9d0d7a788df5c9f5aa3ac6e98ae7ad68d29b650411d6c95aaddb
          |Timestamp(2019-12-16T11:17:54.940779Z)
          ...
          |ContractId(ContractId(0007e7b5534931dfca8e1b485c105bae4e10808bd13ddc8e897f258015f9d921c5))
          | 0649b1e1e7f34be457c44146e449299109167b9199101349873142ed05878b96
          |ContractId(ContractId(0059b59ad7a6b6066e77b91ced54b8282f0e24e7089944685cb8f22f32fcbc4e1b))
          | 0b8c0cc8ebbd56e275b60cf73133387322a42448986dc3858b31eef23098e8e8
          |Optional(None)
          | 01cf85cfeb36d628ca2e6f583fa2331be029b6b28e877e1008fb3f862306c086
          |Optional(Some(Bool(false)))
          | ea87c0c1539dfbbd804c58717ecf30f5b50b946638a39fdaf6712253b952ab40
          |Optional(Some(Bool(true)))
          ...
          |Optional(Some(Optional(Some(Bool(false)))))
          | d9ef2f4d617d921548e1e01da5af2b7ff67e7ed24a0cbd2e29fd30f4cce6ac4e
          |List(FrontStack())
          | 01cf85cfeb36d628ca2e6f583fa2331be029b6b28e877e1008fb3f862306c086
          |List(FrontStack(Bool(false)))
          | ea87c0c1539dfbbd804c58717ecf30f5b50b946638a39fdaf6712253b952ab40
          |List(FrontStack(Bool(true)))
          | 5b5ca90960b8594498cc778421a40ff2aed14d788d06ede5d4a41207933d3e13
          |List(FrontStack(Bool(false),Bool(false)))
          | 8f5dff2ff3f971b847284fb225522005587449fad2746879a0280bbd036f1abc
          |List(FrontStack(Bool(false),Bool(true)))
          | 4f6de867c24682cee05db95d48e1ea47cf5f8b6e74fe07582d3cd8cecaea84b7
          |List(FrontStack(Bool(true),Bool(false)))
          | 768c5b90ed7ae5b727381e331fac83d7defd397d040f46ba067c80ec2af3eb33
          |TextMap(SortedLookupList())
          | 01cf85cfeb36d628ca2e6f583fa2331be029b6b28e877e1008fb3f862306c086
          |TextMap(SortedLookupList((a,Bool(false))))
          | 4c4384399821a8ed7526d8b29dc6f76ad87014ade285386e7d05d71e61d86c7c
          |TextMap(SortedLookupList((a,Bool(true))))
          | 23c43da46c9b2cdc82d54385808ae5b3ffe3606ae516231d2869fea82067c204
          |TextMap(SortedLookupList((b,Bool(false))))
          | b0c45256eea6bf29c0390e82ce89efe2974db7af5dad8f14d25dad6a92cf3faf
          |TextMap(SortedLookupList((a,Bool(false)),(b,Bool(false))))
          | 132fba96cd6130c57d63f8eb2b9a245deaa8a618c4cb9793af32f1190624e6bd
          |TextMap(SortedLookupList((a,Bool(true)),(b,Bool(false))))
          | 954d9283d02236a4f1cd6d1cdf8f8c8a0ced4fc18f14a8380574c4d09485ec60
          |TextMap(SortedLookupList((a,Bool(false)),(b,Bool(true))))
          | da9ab333c3de358c2e5aead8a9ced5cbe5dda7fc454ade82180596120c5abdc6
          |TextMap(SortedLookupList((a,Bool(false)),(c,Bool(false))))
          | 5ac45cbc29a66cd2f10dad87daf37dbb5fa905f5647586fc5f2eafca5d349bac
          |GenMap()
          | 01cf85cfeb36d628ca2e6f583fa2331be029b6b28e877e1008fb3f862306c086
          |GenMap((Text(a),Bool(false)))
          | 4c4384399821a8ed7526d8b29dc6f76ad87014ade285386e7d05d71e61d86c7c
          |GenMap((Text(a),Bool(true)))
          | 23c43da46c9b2cdc82d54385808ae5b3ffe3606ae516231d2869fea82067c204
          |GenMap((Text(b),Bool(false)))
          | b0c45256eea6bf29c0390e82ce89efe2974db7af5dad8f14d25dad6a92cf3faf
          |GenMap((Text(a),Bool(false)),(Text(b),Bool(false)))
          | 132fba96cd6130c57d63f8eb2b9a245deaa8a618c4cb9793af32f1190624e6bd
          |GenMap((Text(a),Bool(true)),(Text(b),Bool(false)))
          | 954d9283d02236a4f1cd6d1cdf8f8c8a0ced4fc18f14a8380574c4d09485ec60
          |GenMap((Text(a),Bool(false)),(Text(b),Bool(true)))
          | da9ab333c3de358c2e5aead8a9ced5cbe5dda7fc454ade82180596120c5abdc6
          |GenMap((Text(a),Bool(false)),(Text(c),Bool(false)))
          | 5ac45cbc29a66cd2f10dad87daf37dbb5fa905f5647586fc5f2eafca5d349bac
          |Enum(Some(pkgId:Mod:Color),Red)
          | 048b20422b487b8eeba059a219589ad477e5f11eb769c7fea658b63f1bb1d405
          |Enum(Some(pkgId:Mod:Color),Green)
          | ff89416f14a9369d7ef3f9a23057878320aa7b777c7233a79f2b0cab812a3e7a
          |Enum(Some(pkgId:Mod:ColorBis),Green)
          | ff89416f14a9369d7ef3f9a23057878320aa7b777c7233a79f2b0cab812a3e7a
          |Record(Some(pkgId:Mod:Unit),ImmArray())
          | 01cf85cfeb36d628ca2e6f583fa2331be029b6b28e877e1008fb3f862306c086
          |Record(Some(pkgId:Mod:UnitBis),ImmArray())
          | 01cf85cfeb36d628ca2e6f583fa2331be029b6b28e877e1008fb3f862306c086
          |Record(Some(pkgId:Mod:Tuple),ImmArray((Some(_1),Bool(false)),(Some(_2),Bool(false))))
          | 8f5dff2ff3f971b847284fb225522005587449fad2746879a0280bbd036f1abc
          |Record(Some(pkgId:Mod:Tuple),ImmArray((Some(_1),Bool(true)),(Some(_2),Bool(false))))
          | 768c5b90ed7ae5b727381e331fac83d7defd397d040f46ba067c80ec2af3eb33
          |Record(Some(pkgId:Mod:Tuple),ImmArray((Some(_1),Bool(false)),(Some(_2),Bool(true))))
          | 4f6de867c24682cee05db95d48e1ea47cf5f8b6e74fe07582d3cd8cecaea84b7
          |Record(Some(pkgId:Mod:TupleBis),ImmArray((Some(_1),Bool(false)),(Some(_2),Bool(false))))
          | 8f5dff2ff3f971b847284fb225522005587449fad2746879a0280bbd036f1abc
          |Variant(Some(pkgId:Mod:Either),Left,Bool(false))
          | 41edeaec86ac919e3c184057b021753781bd2ac1d60b8d4329375f60df953097
          |Variant(Some(pkgId:Mod:Either),Left,Bool(true))
          | 31d69356947365e8a3dd9706774182e86774af1aa6550055efc56a22bb594745
          |Variant(Some(pkgId:Mod:Either),Right,Bool(false))
          | bd89c47c2379a69e8e0d46ff634c533449e8e7e532e84def4e2b2e168bc786e7
          |Variant(Some(pkgId:Mod:EitherBis),Left,Bool(false))
          | 41edeaec86ac919e3c184057b021753781bd2ac1d60b8d4329375f60df953097
          |""".stripMargin
