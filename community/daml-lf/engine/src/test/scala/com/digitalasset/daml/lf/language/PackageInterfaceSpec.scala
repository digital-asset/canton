...
class PackageInterfaceSpec
  ...
  test(
    ...
    toContext = Reference.DataRecord.apply,
  )(
    nonErrorCase =
  ...
  test(
    ...
    toContext = Reference.DataVariant.apply,
  )(
    nonErrorCase =
  ...
  test(
    ...
    toContext = Reference.DataEnum.apply,
  )(
    nonErrorCase =
  ...
  test(
    ...
    toContext = (x: Ref.TypeConId) => Reference.Template(x.toRef),
  )(
