...
- navigate to the example dir: `cd <code_repo_root>/community/app/target/release/canton/examples/07-repair`

## Recovering from a broken Synchronizer
...
- Initialization script:
  `synchronizer-repair-init.canton` that populates the participants and "lostSynchronizer" with Iou contracts
