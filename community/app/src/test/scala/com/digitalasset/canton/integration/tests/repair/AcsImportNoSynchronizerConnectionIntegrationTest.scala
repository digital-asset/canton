...
We want to be sure that the participant does not get transactions to process before it successfully imported the ACS snapshot.
 */
final class AcsImportNoSynchronizerConnectionIntegrationTest
