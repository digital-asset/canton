      ...
      runAndAssertCommandSuccess(
        Process(
          Seq(
            ...
            // TODO(#35500): Because of LAPI strictness and v31/dev PTP mapping topology transaction,
            //  bash/python scripts (client) was forced to be protocol version aware. Possibly reconsider.
            "--protocol-version",
            testedProtocolVersion.toString,
            "run-demo",
