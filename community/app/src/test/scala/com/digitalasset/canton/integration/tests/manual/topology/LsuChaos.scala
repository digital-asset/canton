...
private[topology] class LsuChaos(
  ...
  private def performLsu(
    ...
    synchronizerOwner.topology.lsu.announcement
...
private[topology] object LsuChaos extends TopologyOperationsCompanion {
