...
import com.digitalasset.canton.version.ProtocolVersion.v34
...
sealed abstract class LsuSuccessorIntegrationTest(
  ...
  protected val ((currSerial, currPV), (nextSerial, nextPV)) = currAndNextSerialAndPV
...
final class LsuSuccessorSerialUpPVDownIntegrationTest
    extends LsuSuccessorAcceptedIntegrationTest((zero, ProtocolVersion.dev) -> (one, v34))
final class LsuSuccessorSerialDownPVUpIntegrationTest
    extends LsuSuccessorRejectedIntegrationTest((one, v34) -> (zero, ProtocolVersion.dev))
