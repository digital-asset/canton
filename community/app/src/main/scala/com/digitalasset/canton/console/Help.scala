...
object Help {
  ...
  /** A short summary of the method (to be displayed in a list)
    ...
    */
  case class Summary(s: String, flag: FeatureFlag = FeatureFlag.Stable) extends StaticAnnotation {
  ...
  /** A sequence of strings classifying the method breadcrumb style (e.g. Seq("Participant", "Diagnostics")).
    ...
    */
  case class Topic(t: Seq[String]) extends StaticAnnotation {
    override def toString(): String = t.mkString(": ")
  }

  /** A tag to indicate nesting of items */
  case class Group(name: String) extends StaticAnnotation {
    override def toString: String = name
  }

  case class MethodSignature(argsWithTypes: Seq[(String, String)], retType: String) {
