...
class InMemorySynchronizerConnectivityStatusStore extends SynchronizerConnectivityStatusStore {
  ...
  private val topologyInitialized: AtomicReference[Boolean] = new AtomicReference[Boolean](false)
