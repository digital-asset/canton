...
import com.digitalasset.canton.participant.protocol.party.PartyReplicationProcessorStore
...
trait AcsReplicationProcessor extends SequencerChannelProtocolProcessor {
  ...
  protected def replicationProgressState: store.AcsReplicationProgress
  ...
  /** Single point of entry for progress monitoring and advancing party replication.
    */
  def progressAcsReplication()(implicit traceContext: TraceContext): Unit

  protected def notifyCounterParticipantAndAcsReplicatorOnError(
