...
/** A [[DigestAccumulator]] processes
  ...
  *
  * Whenever
  * [[com.digitalasset.canton.participant.commitment.BaseDigestProcessor.CheckpointWritten]] is
  * emitted, the digest accumulator implementation MUST guarantee that all changes to digests up to
  * [[com.digitalasset.canton.participant.commitment.BaseDigestProcessor.CheckpointWritten.offsetInclusive]]
  * have been persisted.
  */
