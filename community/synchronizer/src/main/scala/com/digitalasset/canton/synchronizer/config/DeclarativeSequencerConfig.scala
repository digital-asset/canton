...
object DeclarativeSequencerConfig {
  implicit val sequencerConfigCantonConfigValidator
      : CantonConfigValidator[DeclarativeSequencerConfig] =
    CantonConfigValidatorDerivation[DeclarativeSequencerConfig]
