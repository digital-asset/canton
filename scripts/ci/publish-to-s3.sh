...
do
  ls -all "/tmp/workspace/community/ledger-test-tool/tool/lf-v$lf_version/target/scala-2.13"
  ...
  run " copy jar to s3" aws s3 cp --no-overwrite \
    "/tmp/workspace/community/ledger-test-tool/tool/lf-v$lf_version/target/scala-2.13/$lapitt_filename" \
