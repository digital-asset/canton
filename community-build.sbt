...
lazy val `ledger-common-dars-lf-v2-2` = CommunityProjects.`ledger-common-dars-lf-v2-2`
...
lazy val `ledger-test-tool-suites-2-2` = CommunityProjects.`ledger-test-tool-suites-2-2`
lazy val `ledger-test-tool-suites-2-dev` = CommunityProjects.`ledger-test-tool-suites-2-dev`
lazy val `ledger-test-tool-2-2` = CommunityProjects.`ledger-test-tool-2-2`
